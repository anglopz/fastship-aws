...
export function SubmitShipmentForm({
  ...
  return (
    <form {...props} onSubmit={(e) => { e.preventDefault(); submitShipment(new FormData(e.currentTarget)); }}>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid gap-2">
            ...
            <p className="text-xs text-muted-foreground">
              Enter the destination zip code where the shipment should be delivered
            </p>
          </div>
          <div className="grid gap-2">
