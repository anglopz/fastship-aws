...
import { Truck, Lock, ArrowLeft, CheckCircle2, AlertCircle } from "lucide-react";
    ...
    return (
      <div className="flex min-h-svh flex-col bg-gradient-to-b from-background via-background to-muted/20">
        <div className="container flex h-16 items-center gap-4 border-b justify-between">
          <Link to="/partner/login" className="flex items-center gap-2 font-semibold hover:opacity-80 transition-opacity">
